...
# รายการบอสขนาดเล็ก
minibosses = [
    Miniboss(bot, "อังโกลท์", (3.5, 6.5), "#000000", url),  # วงดำ
    Miniboss(bot, "คิอารอน", (4.5, 7.5), "#FF0000", url),  # วงแดง
    Miniboss(bot, "กริซ", (5.5, 8.5), "#0000FF", url),  # วงฟ้า
    Miniboss(bot, "อินเฟรโน", (6.5, 9.5), "#00FF00", url),  # วงเขียว
]
