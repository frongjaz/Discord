...
class Miniboss:
    ...
    async def spawn(self, death_time_str, channel):
        ...
        if self.set_death_time(death_time_str):
            ...
            spawn_location = self.color  # ใช้สีวงในการบอกจุดเกิด
            embed = discord.Embed(
...
# รายการบอสขนาดเล็ก
minibosses = [
    Miniboss("อังโกลท์", (3.5, 6.5), "วงดำ", url),  # วงดำ
    Miniboss("คิอารอน", (4.5, 7.5), "วงแดง", url),  # วงแดง
    Miniboss("กริซ", (5.5, 8.5), "วงฟ้า", url),  # วงฟ้า
    Miniboss("อินเฟรโน", (6.5, 9.5), "วงเขียว", url),  # วงเขียว
]
